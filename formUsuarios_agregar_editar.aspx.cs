...
{
    public partial class formAgregarUsuario : System.Web.UI.Page
    {
        string var_tipoUsuario_string = "";
        ...
        //{
        //    //var_idTIPOUSUARIO_FK_int = clases.metodo_obtener_idTIPOUSUARIO_FK(var_tipoUsuario_string);
        //    string variable_idTIPOUSUARIO_FK = clases.metodo_obtener_idTIPOUSUARIO_FK(var_tipoUsuario_string).ToString();
        //    Response.Write("<script language=javascript>alert('" + variable_idTIPOUSUARIO_FK + "');</script>");
        //}
