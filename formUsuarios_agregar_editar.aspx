<%@ Page Title="agregar usuarios  - isomed" Language="C#" MasterPageFile="~/pagina_maestra.Master" AutoEventWireup="true" CodeBehind="formUsuarios_agregar_editar.aspx.cs" Inherits="isomedGUMO.formAgregarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
                <tr>
                    ...
                    <td>&nbsp;
                        <asp:RadioButton ID="rbuAdministrador" runat="server" Font-Names="Aptos Display" Text="Administrador" GroupName="tipo_de_cliente" OnCheckedChanged="rbuAdministrador_CheckedChanged" ForeColor="#535353" />
                        &nbsp;
                    <asp:RadioButton ID="rbuColaborador" runat="server" Font-Names="Aptos Display" Text="Colaborador" GroupName="tipo_de_cliente" OnCheckedChanged="rbuColaborador_CheckedChanged" ForeColor="#535353" />
                        &nbsp;
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbo_idCLIENTE_FK" runat="server" Width="107px" Font-Names="Aptos Display" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" MaxLength="10" ForeColor="#535353"></asp:TextBox>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbo_nombre_completoUSUARIO" onkeyup="this.value=this.value.toUpperCase()" runat="server" Width="489px" Font-Names="Aptos Display" ForeColor="#535353"></asp:TextBox>
                    </td>
